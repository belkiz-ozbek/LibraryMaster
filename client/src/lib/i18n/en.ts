export const en = {
  ...
  dashboard: {
    ...
    days: "{{count}} days",
    changeBooks: "12% from last month",
    changeMembers: "8% from last month",
    avgDays: "Avg. 9 days",
    ...
    quickBorrowDesc: "Scan and borrow a book",
    processReturn: "Process Return",
    processReturnDesc: "Return a borrowed book"
  },
  notFound: {
