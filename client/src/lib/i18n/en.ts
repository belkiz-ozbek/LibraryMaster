export const en = {
  ...
  verifyEmail: {
    ...
    successDesc: "Your account has been created and verified. You can now log in to your account.",
    error: "Verification Failed",
    errorTitle: "Email verification failed",
    errorGeneric: "Email verification failed. Please try again.",
    errorInvalidToken: "Invalid verification token.",
    errorTokenExpired: "Verification token has expired.",
    errorServerError: "Server error occurred during verification.",
    resendEmail: "Resend Verification Email",
    resendEmailSuccess: "Verification email sent successfully",
    resendEmailSuccessDesc: "Please check your email for the verification link.",
    resendEmailFailed: "Failed to resend verification email",
    resendEmailFailedDesc: "Please try again later.",
    emailNotFound: "Email not found",
    emailNotFoundDesc: "Please enter your email address to resend verification.",
  ...
  members: {
    ...
    details: {
      ...
      tabs: {
        ...
        currentlyBorrowed: "Currently Borrowed",
        overdue: "Overdue Borrowings",
      },
      borrowings: {
        title: "Borrowings",
        records: "borrowing records",
        noBorrowings: "No borrowings for this member.",
        book: "Book",
